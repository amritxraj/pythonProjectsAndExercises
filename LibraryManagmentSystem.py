"""
Creating a Class To form a library
1st Class:- displayBook()
2nd Class:- lendBook()
3rd Class:- addBook()
4th Class:- returnBook()

Constructors Used in the project be like:-
RamLibraray = Library(ListOfBooks, Library_name)

Dictionary (Boooks-nameofperson)

creating a main function and run an infinite while loop asking user
for their input
